...
<section id="popup-legalsInfo" style="visibility:hidden; opacity:0;" onclick="ClosePopUp()">
    <div class="popup-legalsInfo-content" style="margin-top: 800px;">
        <p>
...
<script>
    let popupLegalsInfo = document.querySelector("#popup-legalsInfo");
    let popupLegalsInfoContent = document.querySelector(".popup-legalsInfo-content");

    function ClosePopUp() {
        popupLegalsInfo.style.visibility = "hidden";
        popupLegalsInfo.style.opacity = 0;
        popupLegalsInfoContent.style.marginTop = "800px";
    }

    function OpenPopUp() {
        popupLegalsInfo.style.visibility = "visible";
        popupLegalsInfo.style.opacity = 1;
        popupLegalsInfoContent.style.marginTop = "0px";
    }
</script>